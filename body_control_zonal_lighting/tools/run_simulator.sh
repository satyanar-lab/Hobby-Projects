...
EXECUTABLE_PATH="${BUILD_DIR}/app/exterior_lighting_node_simulator"
CONFIG_PATH="${PROJECT_ROOT}/config/vsomeip/exterior_lighting_node_simulator.json"

export VSOMEIP_CONFIGURATION="${CONFIG_PATH}"
export VSOMEIP_APPLICATION_NAME="exterior_lighting_node_simulator"
...
"${EXECUTABLE_PATH}" 2>>/tmp/exterior_lighting_node_simulator_stderr.log